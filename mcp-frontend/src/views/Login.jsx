    ...
    <div className="flex min-h-[70vh] flex-col justify-center px-4 py-12 sm:px-6">
      <div className="mx-auto w-full max-w-md">
        <div className="mb-10 text-center">
          <h2 className="text-3xl font-bold text-neutral-100 sm:text-4xl">Welcome back</h2>
          <p className="mt-2 text-sm text-neutral-500">Sign in to your MCP Store account</p>
        </div>
        ...
        <div className="rounded-2xl border border-white/[0.06] bg-claude-surface/40 p-8">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between gap-4">
              <label className="flex cursor-pointer items-center gap-2">
                <input
                  ...
                  onChange={handleChange}
                  className="h-4 w-4 rounded border-white/20 bg-claude-bg text-neutral-200"
                />
                <span className="text-sm text-neutral-500">Remember me</span>
              </label>
              <a href="#" className="text-sm text-neutral-400 underline-offset-4 hover:text-neutral-200 hover:underline">
                Forgot password?
              </a>
            </div>
            ...
            <button
              type="submit"
              className="w-full rounded-xl bg-neutral-200 py-3 text-sm font-semibold text-neutral-900 transition hover:bg-white"
            >
              Sign in
            </button>
        ...
        <p className="mt-8 text-center text-sm text-neutral-500">
          ...
          <Link href="/sign" className="font-medium text-neutral-200 underline-offset-4 hover:underline">
            Sign up
          </Link>
        </p>
      </div>
